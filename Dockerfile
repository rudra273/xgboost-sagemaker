...
RUN apk add --no-cache --virtual .build-deps gcc musl-dev libffi-dev python3-dev libxml2-dev libxslt-dev && \
...
RUN rm -rf /var/cache/apk/* /src/tests /src/docs /src/*.log /src/__pycache__
